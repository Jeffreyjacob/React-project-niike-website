  ...
  return (
    ...
    max-container'>
      <div className='relative xl:w-2/5 flex flex-col 
        justify-center items-start w-full max-lg:padding-x pt-28 '>
        <p className='text-xl text-coral-red font-montserrat mb-8'>Our summer collections</p>
        <h1 className='font-palanquin text-8xl font-bold 
        ...
        <p className='font-montserrat text-slate-gray
            text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>Discover stylish Nike arrivals, quality comfort, and
          innovation for your active life.
        </p>
        <Button title='Show now' icon={arrowRight} />
      ...
      <div className='relative flex-1 flex justify-center items-center
        ...
        <img src={bigShoeImage}
          ...
          <div className="flex sm:gap-6 gap-4 absolute -bottom-[8%] sm:left-[10%] max-sm:px-4 ">
        {
          shoes.map((shoe,i) => (
            <div key={i}>
              <ShoeCard
